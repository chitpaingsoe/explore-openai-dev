...
for _ in range(100):  # Insert 100 rows as an example
    ...
    town = townName
    incident_date_time = f"2023-09-{random.randint(1, 30)} {random.randint(0, 23)}:{random.randint(0, 59)}:00"

    insert_query = f"""
        INSERT INTO Incident (
            Location, Junctions, WeatherConditions, LightingConditions,
            ...
            '{location}', '{junctions}', '{weather_conditions}', '{lighting_conditions}',
